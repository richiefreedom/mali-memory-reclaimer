...
*/
	...
	/*
	 * This is required to satisfy SEC validation report
	 * which guides suspend routine should keep this state to guarantee
	 * power off completion by minimum delay 50ms.
	 */
	mdelay(30);
